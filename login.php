...
<body class="content">
    <nav>
        <div class="navbar">
            ...
            <div class="navitem"><a href="login.html" class="active navitem">Login</a></div>
        </div>
    </nav>
    <main id="main-holder" class="textbody">
        <h1 id="title login-header">
            Login
        </h1>

        <input class="inputField" type="password" placeholder="De code" id="username">
        <button id="button" onclick="checkvalue()">login</button>
